...
Private Sub Command1_Click()                                                    '确定按钮
    ...
    Print #8, "条形码:" & Form2.SkinLabel2(n).Caption & " " & "姓名:" & Form2.SkinLabel3(n).Caption & " " _
    & "ID:" & Form2.SkinLabel78(n).Caption & " " _
    & "性别:" & Form2.SkinLabel4(n).Caption & " " & "年龄:" & Form2.SkinLabel5(n).Caption & " " _
    & "科室:" & Form2.SkinLabel6(n).Caption & " " & "培养结果:" & Form3.SkinLabel21.Caption & " " _
    & "培养起始时间:" & Form3.SkinLabel16.Caption & " " & "取出时间:" & Format(Now, "mm-dd hh:mm")
