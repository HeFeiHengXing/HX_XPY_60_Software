...
Private Sub Command1_Click()
    ...
    For k = 0 To 59
        ...
        If (bPositive And (Val(Form2.SkinLabel10(k).Caption) = 2 Or Val(Form2.SkinLabel10(k).Caption) = 4)) Or ((Not bPositive) And (Val(Form2.SkinLabel10(k).Caption) = 3)) Then
            ...
            Print #8, "条形码:" & Form2.SkinLabel2(k).Caption & " " & "姓名:" & Form2.SkinLabel3(k).Caption & " " _
            & "ID:" & Form2.SkinLabel78(k).Caption & " " _
            & "性别:" & Form2.SkinLabel4(k).Caption & " " & "年龄:" & Form2.SkinLabel5(k).Caption & " " _
            & "科室:" & Form2.SkinLabel6(k).Caption & " " & "培养结果:" & strResult & " " _
            & "培养起始时间:" & Form2.SkinLabel9(k).Caption & " " & "取出时间:" & Format(Now, "mm-dd hh:mm")
